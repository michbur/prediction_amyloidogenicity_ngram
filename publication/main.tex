...
\url{www.github.com/michbur/prediction_amyloidogenicity_ngram}.
\end{abstract}
...
4. Extraction of encoded n-grams of differnt types: continuous with the length from 1 to 3 residues; gapped 2-grams with a gap of the length from 1 to 3 residues; gapped 3-grams with a single gap between residues (not all possibilities shown).
